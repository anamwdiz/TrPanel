...
while true; do
	...
	wget -nv -O sentora_core.zip https://demo.treidnt.com/sentora-core-dev.zip
...
while true; do
	...
	wget -nv -O sentora_preconfig.zip https://demo.treidnt.com/sentora-installers-dev.zip
